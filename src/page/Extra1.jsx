...
const products = [
  { id: 1, name: "Classic White", image: logo },
  { id: 2, name: "Premium Black", image: logo1 },
  { id: 3, name: "Royal Navy", image: logo2 },
  { id: 4, name: "Luxury Beige", image: logo3 },
  { id: 5, name: "Luxury Beige", image: logo4 },
];
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-end mt-6">
                    <button
                      ...
                      className="px-6 py-3 rounded-full bg-[#D4AF37] text-black font-semibold hover:bg-white transition"
                    >
                      More Details
                    </button>
                  </div>
