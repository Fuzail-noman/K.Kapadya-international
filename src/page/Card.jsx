  ...
  return (
    ...
    >
      <div className="max-w-2xl mx-auto">
        ...
        <h1 className="font-serif text-3xl md:text-4xl text-[#f3ede0] mb-6">Your Cart</h1>
              ...
              <AnimatePresence>
                {cart.map((item, i) => (
                  <motion.div
                    ...
                    className="flex gap-4 bg-[#141317] border border-[#D4AF37]/20 rounded-2xl p-3.5"
                  >
                    <div
                      className="w-19 h-24 rounded-lg flex-shrink-0"
                      style={{ background: item.gradient }}
                    />
                    <div className="flex-1 min-w-0">
                      <span className="text-[11px] text-[#9b9488]">{item.brand}</span>
                      <h3 className="font-serif text-[#f3ede0] text-lg my-0.5">{item.name}</h3>
                    ...
                    <div className="text-[#D4AF37] font-bold text-sm whitespace-nowrap">
                      {formatPrice(item.price * item.quantity, user)}
                    </div>
                  </motion.div>
                ))}
              </AnimatePresence>
