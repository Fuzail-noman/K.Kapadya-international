  ...
  return (
    <footer className="bg-[#0B0B0B] px-6 lg:px-16 relative overflow-hidden">
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 pb-12 text-center lg:text-left">
          <motion.div
          ...
          >
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-w-xs mx-auto lg:mx-0">
              Crafting luxury Pakistani Shalwar Kameez with premium fabric and
              timeless tailoring — delivered worldwide.
            </p>
          </motion.div>
              ...
              {quickLinks.map((link) => (
                <li key={link.label}>
                  <motion.a
                    ...
                    className="text-gray-400 text-sm inline-block transition-colors"
                  >
                    {link.label}
                  </motion.a>
                </li>
